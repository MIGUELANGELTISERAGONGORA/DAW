    ...
    <div className="bg-[#0b1428] border border-blue-900/60 rounded-xl p-4 shadow-xl space-y-4">
      ...
      <div className="flex items-center justify-between pt-1">
        ...
        <button
          ...
          className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-500 hover:to-sky-500 text-white shadow-sm transition-all disabled:opacity-50"
        >
