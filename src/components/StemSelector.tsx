    ...
    <div className="bg-[#0b1428] border border-blue-900/60 rounded-xl p-4 shadow-xl space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 text-xs">
          <button
            onClick={onSelectAll}
            className="px-2.5 py-1 rounded bg-blue-950/80 hover:bg-blue-900 text-sky-200 transition-colors border border-blue-800/60 cursor-pointer"
          >
            Todas
          </button>
          <button
      ...
      <div className="bg-[#050a16] border border-blue-900/60 rounded-lg p-3 space-y-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className="flex items-center space-x-1 px-3 py-1.5 rounded bg-blue-950/80 hover:bg-blue-900 text-xs text-sky-200 border border-blue-800/60 transition-colors shrink-0 cursor-pointer"
          >
      ...
      <button
        ...
        className={`w-full py-3 px-4 rounded-xl font-bold text-sm flex items-center justify-center space-x-2 shadow-lg transition-all cursor-pointer ${
          isProcessing
