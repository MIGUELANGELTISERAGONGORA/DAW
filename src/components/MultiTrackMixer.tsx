      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-blue-900/40 pb-3">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-blue-950/80 hover:bg-blue-900/80 text-sky-200 border border-blue-800/60 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold bg-sky-500 hover:bg-sky-400 text-slate-950 shadow-md shadow-sky-500/20 transition-all disabled:opacity-40"
          >
      ...
      <div className="flex items-center space-x-3 w-full md:w-56 shrink-0">
        ...
        <div className="flex items-center space-x-1 shrink-0">
          <button
            ...
            className="p-1.5 rounded bg-blue-950/80 hover:bg-sky-500 text-sky-200 hover:text-slate-950 border border-blue-800/60 transition-colors"
          ...
          <button
            ...
            className="flex items-center space-x-1 px-2.5 py-1 rounded bg-sky-500/10 hover:bg-sky-500/20 text-sky-300 border border-sky-500/30 text-[11px] font-bold transition-colors"
      ...
      <div className="flex flex-wrap items-center gap-2 shrink-0">
        ...
        {onSensitivityChange && (
          <button
            ...
            className={`flex items-center space-x-1 px-2 py-1 rounded text-[10px] font-bold transition-all border ${
              sensitivity > 1.0
